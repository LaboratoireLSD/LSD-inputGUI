...
class MedTreeView(QtGui.QGraphicsView):
    ...
    def _loadTree(self,primitive,row,column,parentRow):
        ...
        :params row:
        :param column:
        :param parentRow: needed to correctly position the graphical objects in the scene.
        '''              
    ...
    def addMultipleChildren(self,numChildToAdd):
        ...
        :param numChildToAdd: Number of children to add.
        :type numChildToAdd: Int.
        '''
        if isinstance(self.currentItem, MedTreeItem):
...
#        '''
#        Reimplementation of QGraphicsView.focusOutEvent(self,event) virtual function
...
class MedTreeArrow(QtGui.QGraphicsWidget):
    ...
    def mousePressEvent(self,event):
        '''
        Reimplementation of QGraphicsWidget.mousePressEvent(self,event).
        Handles a mouseClick on the item.
        Reimplementation is needed if we want the release to be later called on this item.
    ...
    def mouseReleaseEvent(self,event):
        '''
        Reimplementation of QGraphicsWidget.mouseReleaseEvent(self,event).
        ...
        self.medChoices.widget().setModel(ChoiceComboBoxModel(self.parentItem().pmt))
