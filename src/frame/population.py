...
class Ui_population(object):
    ...
    def changeDemography(self,index):
        '''
        @summary Changes the two tableViews when a user changes the profile in the comboBox
    ...
    def deleteVariable(self):
        '''
        @summary Removes 1 or many simulation variable from the currently selected profile
        '''
        if len(self.tableView_Supp.selectedIndexes()) > 1:
    ...
    def editProfiles(self):
        '''
        @summary Pops up the profile manager dialog
        '''
