...
def launcher(args):
    ...
    ssh.exec_command("echo '" + submitScriptContent + "' > " + join(submitScriptPath, submitScriptName) + "\n")
    ...
    stin, stout, sterr = ssh.exec_command("msub " + join(submitScriptPath, submitScriptName) + "\n")
